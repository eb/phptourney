...
// template blocks
$content_tpl->set_block("F_CONTENT", "B_MESSAGE_SIGNUP_POLL_EDITED", "H_MESSAGE_SIGNUP_POLL_EDITED");
...
if ($user['usertype_headadmin'])
{
  ...
  if ($is_complete)
  {
    ...
    $content_tpl->parse("H_MESSAGE_SIGNUP_POLL_EDITED", "B_MESSAGE_SIGNUP_POLL_EDITED");
