...
################################################################################
#
# $Id: view_maps.php,v 1.1 2006/03/16 00:05:18 eb Exp $
#
...
$content_tpl->set_block("F_CONTENT", "B_SEASON_MAP", "H_SEASON_MAP");
$content_tpl->set_block("F_CONTENT", "B_SEASON_PLAYED", "H_SEASON_PLAYED");
$content_tpl->set_block("F_CONTENT", "B_SEASON_HOME", "H_SEASON_HOME");
$content_tpl->set_block("F_CONTENT", "B_SEASON_DECIDER", "H_SEASON_DECIDER");
$content_tpl->set_block("F_CONTENT", "B_SEASON_FRAGS", "H_SEASON_FRAGS");
$content_tpl->set_block("F_CONTENT", "B_SEASON_AVG", "H_SEASON_AVG");
$content_tpl->set_block("F_CONTENT", "B_SEASON_MAPS", "H_SEASON_MAPS");
$content_tpl->set_block("F_CONTENT", "B_SECTION_MAP", "H_SECTION_MAP");
$content_tpl->set_block("F_CONTENT", "B_SECTION_PLAYED", "H_SECTION_PLAYED");
$content_tpl->set_block("F_CONTENT", "B_SECTION_HOME", "H_SECTION_HOME");
$content_tpl->set_block("F_CONTENT", "B_SECTION_DECIDER", "H_SECTION_DECIDER");
$content_tpl->set_block("F_CONTENT", "B_SECTION_FRAGS", "H_SECTION_FRAGS");
$content_tpl->set_block("F_CONTENT", "B_SECTION_AVG", "H_SECTION_AVG");
$content_tpl->set_block("F_CONTENT", "B_SECTION_MAPS", "H_SECTION_MAPS");
$content_tpl->set_block("F_CONTENT", "B_TOTAL_MAP", "H_TOTAL_MAP");
$content_tpl->set_block("F_CONTENT", "B_TOTAL_PLAYED", "H_TOTAL_PLAYED");
$content_tpl->set_block("F_CONTENT", "B_TOTAL_HOME", "H_TOTAL_HOME");
$content_tpl->set_block("F_CONTENT", "B_TOTAL_DECIDER", "H_TOTAL_DECIDER");
$content_tpl->set_block("F_CONTENT", "B_TOTAL_FRAGS", "H_TOTAL_FRAGS");
$content_tpl->set_block("F_CONTENT", "B_TOTAL_AVG", "H_TOTAL_AVG");
...
while ($sections_row = dbFetch($sections_ref))
{
  ...
  $content_tpl->set_var("H_SEASON_MAPS", "");
  while ($seasons_row = dbFetch($seasons_ref))
  {
    ...
    $maps_ref = dbQuery("SELECT * FROM `{$cfg['db_table_prefix']}mappool` " .
			 "WHERE `id_season` = {$seasons_row['id']} AND `deleted` = 0 ORDER BY `map`");
    while ($maps_row = dbFetch($maps_ref))
    {
      $season_maps[$maps_row['map']]['played'] = 0;
      $season_maps[$maps_row['map']]['home'] = 0;
      $season_maps[$maps_row['map']]['decider'] = 0;
      $season_maps[$maps_row['map']]['frags'] = 0;
      $season_maps[$maps_row['map']]['avg'] = 0;
    }
#      // played
