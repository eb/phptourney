...
################################################################################
#
# $Id: accept.php,v 1.1 2006/03/16 00:05:18 eb Exp $
#
...
// template blocks
$content_tpl->set_block("F_CONTENT", "B_MESSAGE_PLAYER_ACCEPTED", "H_MESSAGE_PLAYER_ACCEPTED");
...
if ($user['usertype_headadmin'])
{
  ...
  else
  {
    ...
    $content_tpl->parse("H_MESSAGE_PLAYER_ACCEPTED", "B_MESSAGE_PLAYER_ACCEPTED");
